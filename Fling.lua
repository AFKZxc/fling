"game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『L！INNI Script』"; Text ="欢迎哥们使用我的甩飞，"; Duration = 4; })
...
TitleTextShadow.Text = "Anli "..version
